# Codex prompt — M00: Reconcile live repository and freeze architecture

Implement milestone **M00** from the Capsule lifecycle programme.
...
8. the previous milestone result (none) when applicable.
