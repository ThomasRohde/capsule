# Codex prompt — M07: Application release upgrade with unchanged data schema

Implement milestone **M07** from the Capsule lifecycle programme.
...
8. the previous milestone result (M06) when applicable.
