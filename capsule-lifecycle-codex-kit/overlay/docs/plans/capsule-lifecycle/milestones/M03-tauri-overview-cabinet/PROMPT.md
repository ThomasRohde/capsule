# Codex prompt — M03: Capsule Overview and Cabinet trusted shell UX

Implement milestone **M03** from the Capsule lifecycle programme.
...
8. the previous milestone result (M02) when applicable.
