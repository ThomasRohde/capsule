# Codex prompt — M09: Plugin sync, hardening, qualification and release

Implement milestone **M09** from the Capsule lifecycle programme.
...
8. the previous milestone result (M08) when applicable.
