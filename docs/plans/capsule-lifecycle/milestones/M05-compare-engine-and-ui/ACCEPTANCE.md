# Acceptance gate — M05: Bounded compare engine and trusted shell comparison
...
- [x] Comparison is read-only and execution-free.
- [x] Undeclared or unstable tables fail closed or remain summary-only per accepted ADR.
- [x] Reports stay bounded and deterministic.
- [x] Sensitive values require explicit trusted-shell disclosure.
- [x] No compare command is available to the raw renderer.
