# Codex prompt — M02: Data contract, lineage and workspace service foundation

Implement milestone **M02** from the Capsule lifecycle programme.
...
8. the previous milestone result (M01) when applicable.
