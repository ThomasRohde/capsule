...
- Add source/target assertions, typed column mapping, allowlisted value maps,
  dataset copy/discard operations and bounded execution.
...
2. Finalise operation profile `org.sqlite-capsule.migration-ops/1`. Keep the
   ...
   - explicit discard for datasets whose signed policy permits omission.
...
8. Add Diagram Studio v1 and v2 fixtures with:
   ...
   - all live Diagram Studio datasets classified and copied according to the
     target contract;
