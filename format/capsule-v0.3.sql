-- SQLite Capsule format v0.3.
-- Accepted by ADR 0021 and materialised by lifecycle milestone M01.
...
CREATE TABLE capsule_manifest (
    ...
    minimum_host_profile    TEXT NOT NULL CHECK (
...
CREATE TABLE capsule_application (
    ...
    icon_asset              TEXT REFERENCES capsule_asset(path),
    release_notes_doc       TEXT REFERENCES capsule_doc(slug)
);
...
CREATE TABLE capsule_instance (
    ...
    cover_asset_id          TEXT REFERENCES capsule_instance_asset(id),
