# Codex prompt — M01: Format v0.3 identity, profile and signature compartment

Implement milestone **M01** from the Capsule lifecycle programme.
...
8. the previous milestone result (M00) when applicable.
