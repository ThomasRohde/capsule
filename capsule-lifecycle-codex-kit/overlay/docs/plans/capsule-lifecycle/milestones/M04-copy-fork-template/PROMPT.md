# Codex prompt — M04: Duplicate, compact duplicate, fork and template creation

Implement milestone **M04** from the Capsule lifecycle programme.
...
8. the previous milestone result (M03) when applicable.
