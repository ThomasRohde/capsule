...
-- Optional publisher-signature extension for compatible capsule v0.2 files.
-- Add these objects before computing the application-compartment digest.

CREATE TABLE capsule_publisher (
    id                  INTEGER PRIMARY KEY CHECK (id = 1),
    profile             TEXT NOT NULL CHECK (profile = 'org.sqlite-capsule.signed-app/0.2'),
