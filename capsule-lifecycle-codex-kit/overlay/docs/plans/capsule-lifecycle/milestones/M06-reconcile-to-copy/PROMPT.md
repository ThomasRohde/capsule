# Codex prompt — M06: Apply selected changes to a new target-derived copy

Implement milestone **M06** from the Capsule lifecycle programme.
...
8. the previous milestone result (M05) when applicable.
