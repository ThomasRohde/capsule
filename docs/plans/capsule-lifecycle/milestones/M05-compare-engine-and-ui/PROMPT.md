# Codex prompt — M05: Bounded compare engine and trusted shell comparison

Implement milestone **M05** from the Capsule lifecycle programme.
...
8. the previous milestone result (M04) when applicable.
